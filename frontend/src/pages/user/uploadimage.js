...
const UploadImage = () => {
  ...
  const uploadImage = () => {
    ...
    axios
      .post(config.serverURL + '/uploadimg/upload-image/' + rId, body, {
        headers: {
  ...
  return (
    ...
    <div className='container'>
      ...
      <div className='mb-3'>
        ...
        <input name='uploadfiletype' id='id_uploadfiletype'
          onChange={(e) => {
          ...
          type='file'
        />
        <Button name='btn_UPLOADImage' style={{  backgroundColor: '#8275a5'}}  id='id_btn_UPLOADImage' onClick={uploadImage} title='Upload Photo'></Button>
      </div>
    </div>
    </>
