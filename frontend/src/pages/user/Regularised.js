...
const Regularised = () => {
  ...
  console.log("Data from UserId in Regularised Page After Login");
  ...
  useEffect(() => {
    ...
    // load all the Regulariseds created by the user
    ...
    axios
      ...
      .then((response) => {
        ...
        if (result['status'] === 'success') {
          ...
          // set the Regulariseds to the state member
    ...
    <>
      ...
      <Grid container spacing={1} margin={1}  >
        <div className="table-responsive" style={{ width: 720, height: 400, textAlign: 'center', justifyContent: 'center', marginLeft: 600, margin: 30 }}>
          <p style={{ fontSize: 20, fontFamily: 'cursive', margin: 1, textAlign: 'center' }}>Leave Status</p>
          <Grid item xs={4} >
        ...
        <div className="table-responsive" style={{ width: 720, height: 400, textAlign: 'center', justifyContent: 'center', marginLeft: 600, margin: 30 }}>
          ...
          <p style={{ fontSize: 20, fontFamily: 'cursive', margin: 1, textAlign: 'center' }}>Reporting Status</p>
          <Grid item xs={4}>
