// //working fine proper without role dropdownlist(no role table using here manual enter roles 'admin,user,manager')
...
//-------------------------------------------------------------------------------------
//below code is working with dropdownlist but token problem for role table
...
//registration page with dropdownlist manually adding roles 'admin,user,manager'
// import axios from 'axios'
// import config from '../../config'
// import { toast } from 'react-toastify'
// import {useState} from 'react'
