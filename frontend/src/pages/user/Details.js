...
// ************************************************************************************************// 
// GET THE USER DETAILS HERE USING MANAGER RID 
// ************************************************************************************************// 
                  ...
                  <MDBModalBody>
                    <div className='container-sm' style={{ width: '750px', height: '580px', borderStyle: '' }}>
                        ...
                        <div className="col">
                          <div class="form-floating">
                            <div className="form-floating">
                              <input type="text" className="form-control" name='empno' id='id_empno' placeholder="Emp No" onChange={(event) => {
                      ...
                      <div className="row" style={{ marginTop: 3, padding: 2 }}>
                        <div className="col">
                          <div class="form-floating">
                            <input type="text" className="form-control" name='firstname' id='id_firstname' placeholder="First Name" onChange={(event) => {
                      ...
                      <div className="row" style={{ marginTop: 3, padding: 2 }}>
                        <div className="col">
                          <div class="form-floating">
                            <input type="text" className="form-control" name='lastname' id='id_lastname' placeholder="Last Name" onChange={(event) => {
                        ...
                        <div className='col'>
                          <div className="form-floating">
                            <input type="date" className="form-control" name='hiredate' id='id_hiredate' placeholder="Password" onChange={(event) => {
                      ...
                      <div className="row" style={{ marginTop: 3, padding: 2 }}>
                        ...
                        <div className='col'>
                          <div className="form-floating">
                            <input type="date" className="form-control" name='birthdate' id='id_birthdate' placeholder="Birth Date" onChange={(event) => {
